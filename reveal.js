...
ScrollReveal().reveal(".banner-description", {
  delay: 500,
  duration: 1000,
  origin: "bottom",
  distance: "200px",
...
ScrollReveal().reveal(".cloth1", {
  ...cloths,
  delay: 500,
});

ScrollReveal().reveal(".cloth2", {
  ...cloths,
  delay: 1000,
});
...
ScrollReveal().reveal(".mp1 img", {
  duration: 1000,
  origin: "right",
  distance: "200px",
});

ScrollReveal().reveal(".mp2", {
  delay: 500,
  duration: 1000,
  origin: "left",
  distance: "200px",
...
ScrollReveal().reveal(".motivational-texts", {
  delay: 500,
  duration: 1000,
  origin: "bottom",
  distance: "200px",
...
ScrollReveal().reveal(".timmy_patrick img", {
  duration: 1000,
  origin: "right",
  distance: "100px",
});

ScrollReveal().reveal(".about_tp_apparel .description", {
  delay: 500,
  duration: 1000,
  origin: "bottom",
  distance: "100px",
...
ScrollReveal().reveal(".cart-icon", {
  duration: 1000,
  origin: "right",
  distance: "100px",
});

ScrollReveal().reveal(".first-cart-text", {
  delay: 500,
  duration: 1000,
  origin: "bottom",
  distance: "100px",
...
ScrollReveal().reveal(".second-cart-text", {
  delay: 1000,
  duration: 1000,
  origin: "bottom",
  distance: "100px",
...
ScrollReveal().reveal(".greeting-image img", {
  duration: 1000,
  origin: "right",
  distance: "200px",
});

ScrollReveal().reveal(".greetings-description", {
  delay: 500,
  duration: 1000,
  origin: "bottom",
  distance: "100px",
...
ScrollReveal().reveal(".faqs-heading", {
  duration: 1000,
  origin: "right",
  distance: "100px",
});
...
ScrollReveal().reveal(".product-delivery input:last-child", {
  delay: 4000,
  duration: 1000,
  origin: "bottom",
  distance: "100px",
...
if (window.innerWidth < 700) {
  ...
  ScrollReveal().reveal(".career-image img", {
    duration: 1000,
    origin: "right",
    distance: "100px",
  });

  ScrollReveal().reveal(".career-text", {
    delay: 500,
    duration: 1000,
    origin: "bottom",
    distance: "100px",
  ...
  ScrollReveal().reveal(".developer .phone:first-child .icon", {
    delay: 4000,
    duration: 1000,
    origin: "right",
    distance: "100px",
  ...
  ScrollReveal().reveal(".developer .phone:last-child .icon", {
    duration: 1000,
    origin: "right",
    distance: "100px",
  });
  ...
  ScrollReveal().reveal(".product-quantity > div:last-child", {
    delay: 4500,
    duration: 1000,
    origin: "bottom",
    distance: "100px",
  ...
  ScrollReveal().reveal(".career-infomation", {
    duration: 1000,
    origin: "bottom",
    distance: "100px",
  });

  ScrollReveal().reveal(".potential-infomation", {
    delay: 500,
    duration: 1000,
    origin: "bottom",
    distance: "100px",
  ...
  ScrollReveal().reveal(".value-infomation", {
    delay: 1500,
    duration: 1000,
    origin: "bottom",
    distance: "100px",
  ...
  ScrollReveal().reveal(".developer .phone:first-child", {
    delay: 4000,
    duration: 1000,
    origin: "bottom",
    distance: "100px",
